...
def update_player_rankings(last_year):
    ...
    for file in os.listdir(os.environ["TENNIS_HOME"] + "//players//players"):
        with open(os.environ["TENNIS_HOME"] + "//players//players//" + file, "r") as player_file:
            player = yaml.safe_load(player_file)
        # TODO: Need to calculate Junior rankings, Wimbledon rankings, senior rankings and doubles rankings
        ...
        if not mandatory:
            ...
            pass
        # TODO: If mandatory
        # TODO: Get each masters, Slam, WTF ranking and all 500s, 250s and go from there?
        ...
        # TODO: Remove useless tie breaks
        print(senior)
        print(doubles)
        print(junior)
        print(wimbledon)
